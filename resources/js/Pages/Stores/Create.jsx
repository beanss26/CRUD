            ...
            <DialogContent className="sm:max-w-[425px] dark:bg-gray-800 text-gray-900 dark:text-gray-100 dark:border-none">
                <form onSubmit={submit}>
                    ...
                    <div className="grid gap-4 mb-7 pt-3">
                        {/* Product Name */}
                        <div className="">
                            <LabelEx htmlFor="product_name" required>
                                Product Name
                            </LabelEx>
                        ...
                        {/* Product Quantity */}
                        <div className="">
                            <LabelEx htmlFor="product_quantity" required>
                                Product Quantity
                            </LabelEx>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData("product_quantity", e.target.value)
                                }
                                type="number"
                                className="mt-1 block w-full py-[0.5rem] px-[.75rem] border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm"
                            />
                        ...
                        {/* Product Price */}
                        <div className="">
                            <LabelEx htmlFor="product_price" required>
                                Product Price
                            </LabelEx>
